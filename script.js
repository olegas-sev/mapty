...
class App {
    ...
    _hideForm() {
        ...
        // In order to hide animation
        form.style.display = 'none'
        form.classList.add('hidden')
        // Turn back to normal state in 1s
    ...
    _newWorkout(e) {
        ...
        if (type === 'running') {
            ...
            if (
                ...
                !allPositive(distance, duration, cadence)) return alert('Inputs have to be a number & positive number!')
        ...
        if (type === 'cycling') {
            ...
            if (
                ...
                !allPositive(distance, duration)) return alert('Inputs have to be a number & positive number!')
